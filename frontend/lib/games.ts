...
export const GAMES: Game[] = [
  ...
  { id: "hytale", name: "Hytale", href: "/games/hytale", status: "soon", accent: "from-blue-500 to-indigo-600" },
  { id: "rust", name: "Rust", href: "#", status: "soon", accent: "from-red-500 to-orange-600" },
  { id: "satisfactory", name: "Satisfactory", href: "#", status: "soon", accent: "from-orange-500 to-amber-600" },
